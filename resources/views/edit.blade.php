        ...
        <div class="row justify-content-center align-items-center inner-row">
            <div class="col-md-5">
                <div class="form-box p-5">
                    ...
                    <form action="{{ route('update',$insert->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control " placeholder="UserName" id="UserName"
                                name="name" value="{{ $insert->name }}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control form-control-sm" placeholder="Email"
                                id="lastName" name="email" value="{{ $insert->email }}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="password" class="form-control form-control-sm" placeholder="Password"
                                id="email" name="password" value="{{ $insert->password }}">
                        ...
                        @enderror
                        <div class="mt-3">
                           <button class="btn primarybg text-white"> Update</button>
                        </div>
                    </form>
